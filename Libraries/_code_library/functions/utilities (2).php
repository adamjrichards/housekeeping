...
function say_red( $this_here ) {
	// echo "#p style='color:red'>$this_here#/p>";
}
function say_green( $this_here ) {
	// echo "#p style='color:green'>$this_here#/p>";
}
function say_blue( $this_here ) {
	// echo "#p style='color:blue'>$this_here#/p>";
}
function say_orange( $this_here ) {
	// echo "#p style='color:orange'>$this_here#/p>";
}
function say_yellow( $this_here ) {
	// echo "#p style='color:yellow'>$this_here#/p>";
}
function say_white( $this_here ) {
	// echo "#p style='color:white;background:black'>$this_here#/p>";
}
