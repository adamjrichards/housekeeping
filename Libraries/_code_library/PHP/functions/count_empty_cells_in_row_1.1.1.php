<?php
	function count_empty_cells_in_row( $file_type, $list_type, $reading_list, $tracking_id ) {
		$empty_cell_count = 0;
		if ( $file_type == "IMAGE" ) {		
			...
			try {
				if ( $count_empty_cells_query = $_SESSION[ "dta_DeepText_1_connection_oop" ] -> query( $count_empty_cells_sql ) ) {
