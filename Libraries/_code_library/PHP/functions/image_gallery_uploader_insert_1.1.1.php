<?php
					...
					for ( $i = 1; $i <= 10; $i++ ) {
						echo "<td>
								<figure>
									...
									<figcaption>" . $book_image_gallery_array[ "dtuc_book_image_" . $i . "_caption" ] . "</figcaption>
								</figure><br>
								<input type='file' name='dtuc_book_image_" . $i . "_binary' id='dtuc_book_image_" . $i . "_binary' accept='image/x-png,image/gif,image/jpeg'><br>
								<input type='button' name='upload_dtuc_book_image_" . $i . "_binary' id='upload_dtuc_book_image_" . $i . "_binary' value='Upload image' onClick='uploadImage( this.file[0] )'>
							</td>";
						if ( $i == 5 ) echo "</tr><tr>";
					} // for
					echo "</tr>";
	...
	} // rimage_gallery_uploader_request()
