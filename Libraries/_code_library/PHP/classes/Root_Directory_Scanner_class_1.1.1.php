<?php
	...
	$root_directory_path = dirname( getcwd() ) . "/pages/";
	...
	class Root_Directory_Scanner {
		...
		function convertToURL( $path ) {
			//echo $path . "<br>";
			$path = str_replace( "%webroot%\\deeptext.ca\\css\\", "https://www.deeptext.ca/css/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\scripts\\", "https://www.deeptext.ca/scripts/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\components\\", "https://www.deeptext.ca/pages/components/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\db_admin\\", "https://www.deeptext.ca/index.php?show_panel=db_admin/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\editor_admin\\", "https://www.deeptext.ca/index.php?show_panel=editor_admin/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\editor_tools\\", "https://www.deeptext.ca/index.php?show_panel=editor_tools/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\error_handling\\", "https://www.deeptext.ca/index.php?show_panel=error_handling/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\error_pages\\", "https://www.deeptext.ca/error_pages/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\guest_content\\", "https://www.deeptext.ca/index.php?show_panel=guest_content/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\guest_admin\\", "https://www.deeptext.ca/index.php?show_panel=guest_admin/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\help\\", "https://www.deeptext.ca/index.php?show_panel=help/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\owner_tools\\", "https://www.deeptext.ca/index.php?show_panel=owner_tools/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\reader_tools\\", "https://www.deeptext.ca/index.php?show_panel=reader_tools/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\server_admin\\", "https://www.deeptext.ca/server_admin/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\user_admin\\", "https://www.deeptext.ca/index.php?show_panel=user_admin/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\user_tools\\", "https://www.deeptext.ca/index.php?show_panel=user_tools/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\classes\\", "https://www.deeptext.ca/classes/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\functions\\", "https://www.deeptext.ca/functions/", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\pages\\", "https://www.deeptext.ca/index.php?show_panel=", $path );
			$path = str_replace( "%webroot%\\deeptext.ca\\", "https://www.deeptext.ca/", $path );
			//echo $path . "<br>";
