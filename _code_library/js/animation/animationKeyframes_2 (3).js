function CSSAnimationObject( name ) {
...
CSSAnimationObject.prototype.createShorthandAnimationPropertyString = function( name, duration, timing, delay, iterations, direction, fill ) {
	return animationString = "animation: " + name + " " + duration + "ms " + timing + " " + delay + "ms " + iterations  + " " + direction  + " " + fill;
} // CSSAnimationObject.prototype.createShorthandAnimationPropertyString
CSSAnimationObject.prototype.createSeparateAnimationPropertyStrings = function( name, duration, timing, delay, iterations, direction, fill ) {
...
} // CSSAnimationObject.prototype.createSeparateAnimationPropertyStrings
CSSAnimationObject.prototype.insertAnimationRuleIntoStyleSheet = function( ruleName, ruleString, styleSheet, index ) {
...
} // CSSAnimationObject.prototype.insertAnimationRuleIntoStyleSheet
CSSAnimationObject.prototype.insertKeyframeRuleIntoStyleSheet = function( ruleString, styleSheet, index ) {
	var allDocumentStyleSheets = document.styleSheets;
	if ( index == null | index == "undefined" ) {
		index = 0;
	} else if ( index == "last" ) {
...
} // CSSAnimationObject.prototype.insertKeyframeRuleIntoStyleSheet
CSSAnimationObject.prototype.replaceKeyframesRuleInObject = function( newKeyframesRuleObject ) {
...
CSSAnimationObject.prototype.appendKeyframesRuleToObject = function( newKeyframesRuleObject ) {
	...
	this.keyCSS.push( newKeyframesRuleObject.keyCSS );
} // appendKeyframesRuleToObject()
CSSAnimationObject.prototype.insertKeyframesRuleIntoLastStyleSheet = function( newKeyframesRuleObject ) {
...
CSSAnimationObject.prototype.getKeyframesRules = function() {
...
CSSAnimationObject.prototype.getKeyframes = function( keyframeRules ) {
	var keyframeString;
...
CSSAnimationObject.prototype.getSingleKeyframe = function( keyframeString ) {
...
function CSSKeyframesRuleObject( keyRule, selectors, styles ) {
...
";
	...
	//console.log( this.newKeyframesRule );
} // createSingleKeyframe()
CSSKeyframesRuleObject.prototype.createNewSingleKeyframe = function( selector, style ) {
