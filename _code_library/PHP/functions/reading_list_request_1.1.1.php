	...
	function reading_list_request() {
		...
		try {
			...
			while( $reading_list_request_array = mysqli_fetch_array( $reading_list_request_query ) ) {
				echo "<optgroup label='Author/editor: " . $reading_list_request_array[ "dtuc_book_author_1_last_name" ] . $reading_list_request_array[ "dtuc_book_editor_1_last_name" ] . "'>";
				echo "<option value='" . $reading_list_request_array[ "dtuc_book_main_title" ] . "&" . $reading_list_request_array[ "dtuc_book_author_1_last_name" ] . $reading_list_request_array[ "dtuc_book_editor_1_last_name" ] . "&" . $reading_list_request_array[ "dtuc_book_tracking_id" ] . "'>TITLE: "  . $reading_list_request_array[ "dtuc_book_main_title" ] . ".</option>";
				echo "</optgroup>";
			} // while
